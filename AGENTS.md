...
Make the new harness compatible with the user’s preferred tools without pretending unsupported integrations already exist.this can be in the form extension or anymethod that can connect to an IDE
