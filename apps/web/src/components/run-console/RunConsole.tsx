...
import { MinimalDiffTestSummary } from './MinimalDiffTestSummary';
import { TaskPlanView } from './TaskPlanView';
import { ToolCallList } from './ToolCallList';
import { VerificationPanel } from './VerificationPanel';
import { collectDiffFiles, getDiffLineClass } from './runSummary';
...
export function RunConsole({
  ...
  const diffFiles = collectDiffFiles(structuredDiff, gitDiff);
  ...
  return (
    <aside className="run-console" data-testid="run-console">
      ...
      <div className="run-console-body">
        ...
        />
        <MinimalDiffTestSummary gitDiff={gitDiff} structuredDiff={structuredDiff} traces={traces} />
        {contextData && (
        ...
        <details className="run-console-advanced-details">
          <summary>Advanced Details · Code changes</summary>
        ...
        <details className="run-console-advanced-details">
          <summary>Advanced Details · Verification</summary>
